...
<div class="escudos"><center><IMG SRC="imagenes/leonesnegros.gif" width='80' height='80'></center></div>
<center><h2>Club Leones Negros</h2></center>
...
$query = "SELECT * FROM Jugador Where Nom_Equipo='Leones Negros'";
