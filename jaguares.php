...
<div class="escudos"><center><IMG SRC="imagenes/jaguares.gif" width='80' height='80'></center></div>
<center><h2>Chiapas FC</h2></center>
...
$query = "SELECT * FROM Jugador Where Nom_Equipo='Chiapas FC'";
