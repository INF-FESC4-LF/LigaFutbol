...
<div class="escudos"><center><IMG SRC="imagenes/atlas.gif" width='80' height='80'></center></div>
<center><h2>Club Atlas</h2></center>
...
$query = "SELECT * FROM Jugador Where Nom_Equipo='Atlas'";
