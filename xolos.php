...
<div class="escudos"><center><IMG SRC="imagenes/xolos.gif" width='80' height='80'></center></div>
<center><h2>Club Tijuana</h2></center>
...
$query = "SELECT * FROM Jugador Where Nom_Equipo='Club Tijuana'";
