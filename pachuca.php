...
<div class="escudos"><center><IMG SRC="imagenes/pachuca.gif" width='80' height='80'></center></div>
<center><h2>Club Pachuca</h2></center>
...
$query = "SELECT * FROM Jugador Where Nom_Equipo='Pachuca'";
