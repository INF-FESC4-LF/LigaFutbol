...
<div class="escudos"><center><IMG SRC="imagenes/monterrey.gif" width='80' height='80'></center></div>
<center><h2>Club Monterrey</h2></center>
...
$query = "SELECT * FROM Jugador Where Nom_Equipo='Monterrey'";
