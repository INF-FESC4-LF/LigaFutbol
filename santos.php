...
<div class="escudos"><center><IMG SRC="imagenes/santos.gif" width='80' height='80'></center></div>
<center><h2>Club Santos Laguna</h2></center>
...
$query = "SELECT * FROM Jugador Where Nom_Equipo='Santos'";
