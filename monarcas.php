...
<div class="escudos"><center><IMG SRC="imagenes/monarcas.gif" width='80' height='80'></center></div>
<center><h2>Club Monarcas Morelia</h2></center>
...
$query = "SELECT * FROM Jugador Where Nom_Equipo='Morelia'";
